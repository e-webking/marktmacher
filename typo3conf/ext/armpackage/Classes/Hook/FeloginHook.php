 ...
 *  Copyright notice
 *
 *  (c) 2019 Anisur Mullick <anisur@armtechnologies.com>, ARMTech
 *  
 *  All rights reserved
 *
...
class FeloginHook
{
	...
	public function checkUser($params) {
            // TODO Checking of the hooks execution
            ...
            if ($GLOBALS['TSFE']->fe_user->user['tx_femanager_activepack'] == 0) {
                $params['redirectUrl'] = '/index.php?id=34';
            }
	}
}
